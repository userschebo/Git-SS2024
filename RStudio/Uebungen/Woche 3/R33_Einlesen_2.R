...
insurances <- read.csv(file="R33d6_insurances.csv", header = TRUE, sep=",", na.strings = "unknown")
readLines("R33d6_insurances.csv", n=10)
...
write.table(x=iris, file="iris.txt", quote=FALSE, row.names = FALSE,
