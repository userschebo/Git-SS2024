...
mortalities <- read.table(file="R33d1_mortalities.txt", header=TRUE)
...
diseases <- read.table(file="R33d2_diseases.txt", header=TRUE, sep="\t")
readLines("R33d2_diseases.txt", n=10)
...
expenditure <- read.table(file="R33d3_expenditure.txt", dec=",", skip=8)
readLines("R33d3_expenditure.txt", n=10)

# A4 ----
mortality <- read.table(file="R33d4_mortality.txt", sep = ";", skip = 5, header=TRUE)
readLines("R33d4_mortality.txt", n=10)
