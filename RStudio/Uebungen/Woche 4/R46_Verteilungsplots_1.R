...
nichtBekannt <- c(-1111.1, -2222, -2222.2)
meta <- read.csv(file = "R46d_Meta.csv", na.strings = nichtBekannt)
gesundheit <- read.csv(file = "R46d_Gesundheit.csv", na.strings = nichtBekannt)
...
# t5_start
hist(gesundheit$Obesity, breaks = 30, las = 1, col = "plum", xlab = "",
